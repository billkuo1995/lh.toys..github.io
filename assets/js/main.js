    ...
    $(".menu-content").each(function() {
        ...
        if ($lis.length > 0) {
            $ul.append(
                $(
                    '<li class="expand">' +
                    (isExpanded ? '<a href="javascript:;"><span><i class="ion-android-remove"></i>關閉閱覽</span></a>' : '<a href="javascript:;"><span><i class="ion-android-add"></i>閱覽更多</span></a>') +
                    "</li>"
                ).on("click", function(event) {
                    var isExpanded = $ul.hasClass("expanded");
                    event.preventDefault();
                    $(this).html(isExpanded ? '<a href="javascript:;"><span><i class="ion-android-add"></i>閱讀更多</span></a>' : '<a href="javascript:;"><span><i class="ion-android-remove"></i>關閉閱覽</span></a>');
...
$(function(){
    $(".card_box span").click(function(event) {
        /* Act on the event */
